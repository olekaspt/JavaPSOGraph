...
//import thesis.graph.measurements.PercentageInLargestCluster;

public class CreateOptimizedHeuristicGraphs1 {
...
//	int MaxEdges = 936;
	...
	String OutDir0 = BaseDir0 + "\\optimizedheuristic";
	String SeedDir0 = BaseDir0 + "\\seed";
	
	String OutDir1 = BaseDir1 + "\\optimizedheuristic1a";
	String SeedDir1 = BaseDir1 + "\\seed";
	
	String OutDir2 = BaseDir2 + "\\optimizedheuristic1a_11";
	String SeedDir2 = BaseDir2 + "\\seed";
	
	String OutDir3 = BaseDir3 + "\\optimizedheuristic1a_11";
	String SeedDir3 = BaseDir3 + "\\seed";
	
	String OutDir4 = BaseDir4 + "\\optimizedheuristic1a";
	String SeedDir4 = BaseDir4 + "\\seed";
	
	String OutDir5 = BaseDir5 + "\\optimizedheuristic1a_11";
	...
	public static void main(String[] args)
	{
		try
		{
			CreateOptimizedHeuristicGraphs1 createOptimizedHeuristicGraphs = new CreateOptimizedHeuristicGraphs1();
	...
	public CreateOptimizedHeuristicGraphs1()
	{
		r = new Random();
