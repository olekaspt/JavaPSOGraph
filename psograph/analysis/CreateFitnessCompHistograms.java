...
import psograph.util.FitnessCompHistogramWriter;




public class CreateFitnessCompHistograms 
{
	FitnessCompHistogramWriter histogramWriter;
	
    public CreateFitnessCompHistograms() throws Exception
    {
    	histogramWriter = new FitnessCompHistogramWriter(20);

    }
        
    public void generateHistorgrams() throws Exception
    {
		...
		i++)
		{
			histogramWriter.processSeedDirectory(seedDirectories[i]);		
		}
